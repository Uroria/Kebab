...
public final class NonNullEntrySet<K, V> implements Set<Map.Entry<K, V>> {
    ...
    public class NonNullEntrySetIterator implements Iterator<Map.Entry<K, V>> {
    ...
    public class NonNullEntry implements Map.Entry<K, V> {
        ...
        public V setValue(V value) {
            ValidUtils.notNull(value, getClass().getSimpleName() + " does not allow setting null");
